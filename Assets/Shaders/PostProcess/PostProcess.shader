Shader "Hidden/PostProcessShader" 
{
	...
	CGINCLUDE
		...
		{/*
			...
			//finalColor.rgb = lerp(finalColor.rgb, half3(0.8, 0.9, 1) * 0.2, 0.5);			
		...
		half4 frag_DownBrightPass(v2f_Downsample IN) : COLOR0
		{
			...
			//finalColor *= 0.25;
			finalColor.rgb = max(half3(0, 0, 0), finalColor.rgb - half3(_BloomParams.w, _BloomParams.w, _BloomParams.w));
